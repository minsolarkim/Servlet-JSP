...
<body>
	<h1>데이터 포맷 지정</h1>
	<h2>숫자 출력 형식 지정 #,###.## / 0,000.00</h2>
	<fmt:formatNumber value="123456789.678" pattern="#,###.##" /><br>
	<fmt:formatNumber value="123456789.678" pattern="0,000.00" />
	<hr>
	<fmt:formatNumber value="1" pattern="#,###.##"/>-----의미가 없으면 빈칸으로<br> 
	<fmt:formatNumber value="1" pattern="0,000.00"/>-----0을 다 채워줌<br>
	...
	<% 
	Date now = new Date(); //Date import해줘야 함
